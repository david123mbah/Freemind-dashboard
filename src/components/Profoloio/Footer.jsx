...
const Footer = () => (
  <motion.footer
    className="w-full bg-black py-6 px-8 flex items-center justify-between font-[Montserrat] text-white text-base"
  ...
  >
    ...
    <div className="flex items-center">
      <img src="/Star 1.png" alt="Logo" className="w-10 h-10" />
    </div>
    {/* Center: Nav links */}
